...
public class fireAlarm implements Serializable  {
	...
	public String toString() {
		...
		return " Floor no : "+floor+"| Room no : "+roomNumber+"| Smoke Level : "+smokelevel+"| CO2 Level : "+co2level;
	}
...
//	public String toString() {
//		// TODO Auto-generated method stub
//		return "ID : "+id+"| Floor no : "+floor+"| Room no : "+roomNumber+"| Smoke Level : "+smokelevel+"| CO2 Level : "+co2level;
//	}
//	public int getId() {
//		return id;
//	}
...
//		super();
//	}
//	public fireAlarm(int id, int floor, int roomNumber, int smokelevel, int co2level) throws RemoteException {
//		super();
//		this.id = id;
//		this.floor = floor;
//		this.roomNumber = roomNumber;
